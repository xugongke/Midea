...
#define TEST_TIME       180 /*测试加热时间S  停止固定10秒*/

#define FACTORY_MODE_CHECK_EN  1 /*是否检查工厂模式 1:使能   0:禁能  正常发布程序时需要使能, 临时测试目的可以关闭*/

#define ACPOWER_ON_DIS_EN   0  /*是否使能市电上电显示   1:使能   0:不使能*/
//#define UART1_SEND_EN       1   /*是否使能UART1发送功能   0:不使能 1:使能    量产时关闭*/

#define TEST_COMM_ERR_EN   1 /*关闭禁能功能 0:关闭通讯超时报警   1:正常功能*/
#define AC_DOWN_TEMP       3  /*交流加热启动下限温度与上限温度差值*/
...
#define LED_POWER_ON  LED_POWER_INIT(); P0_2 = 0
#define LED_POWER_OFF LED_POWER_INIT(); P0_2 = 1


extern bit  FactorMode; //是否工厂模式 1:工厂模式
extern bit  FactoryLEDOff; /*上电时工厂模式 熄屏*/
extern u8 StateCnt;     //当前状态分阶段计数
extern u16 StateStartTick;
...
#define MODE_CHECK      6 /*自检模式*/

extern vu8 HTMode; /*当前是否为高温杀菌模式0:是  1:否*/
extern u8 fast_cnt; //用于尽快更新同步串口信息  小于4时快速同步
extern vs8 DCTempHeatUp; /*直流加热上限*/
extern vs8 MixHeatUp;//混合模式下交流加热上限
...
extern u8 time_flash; //高温杀菌模式下闪烁5秒用
