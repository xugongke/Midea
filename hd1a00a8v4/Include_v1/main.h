...
#define MODE_BOOAST     1 /*速热模式(市电加热)*/
//#define MODE_ECO        2 /*ECO模式*/
#define MODE_HIGH_TEMP  3 /*高温杀菌模式*/
//#define MODE_TIMEING    4 /*预约模式*/
#define MODE_OPEN       5 /*刚开机状态*/
