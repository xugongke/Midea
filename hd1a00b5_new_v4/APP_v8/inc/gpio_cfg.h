...
extern u8 MCtrl;       /*主显示板控制:  bit[0]:1:交流加热; 0:交流不加热   bit[7]:自检模式 1:进入自检模式    bit[1]:自检模式下控制直流加热  bit[1~7]暂时不使用*/

#define GF_VOL_HIGH     (0X10) /*光伏电压过高*/
#define COM_ERR_ST      (0X20)  /*通讯超时*/
...
#define RELAY_NORMAL_OPEN_STATE   0 /*1:表示继电器是常开状态   0:表示继电器是常闭状态*/
